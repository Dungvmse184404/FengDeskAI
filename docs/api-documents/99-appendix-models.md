...
| `Model3DRequestStatus` | `Queued` (0), `Processing` (1), `AwaitingStaff` (2), `InProgress` (3), `Succeeded` (4), `Failed` (5), `Rejected` (6) — xem [`docs/adr/refactor-model3d-request-flow.md`](../adr/refactor-model3d-request-flow.md) |
