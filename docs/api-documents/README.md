...
| 02 | [Products](./02-products.md) | `ProductsController` | 23 | Sản phẩm, SKU, ảnh, model 3D (request), phong thủy (`placement`, `aspiration`) |
...
| 07 | [Elements](./07-elements.md) | `ElementsController` | 3 | Tra cứu ngũ hành |
| 08 | [Cart](./08-cart.md) | `CartController` | 5 | Giỏ hàng |
| 09 | [Orders](./09-orders.md) | `OrdersController` | 11 | Đơn hàng, checkout, delivery |
| 10 | [Payments](./10-payments.md) | `PaymentsController` | 5 | Thanh toán PayOS, webhook |
| 11 | [Returns](./11-returns.md) | `ReturnsController` | 19 | Trả hàng / hoàn tiền / đổi (RMA) |
| 12 | [Shipping](./12-shipping.md) | `ShippingController` | 8 | Webhook GHN/AhaMove, tiến trình giao |
| 13 | [Addresses](./13-addresses.md) | `AddressesController` | 6 | Sổ địa chỉ user |
| 14 | [Locations](./14-locations.md) | `LocationsController` | 4 | Tỉnh → quận → phường |
| 15 | [Stores](./15-stores.md) | `StoresController` | 22 | Garden store, owner, staff, địa chỉ |
| 16 | [Workspace Profiles](./16-workspace-profiles.md) | `WorkspaceController` | 18 | Hồ sơ không gian + AI intake + placement |
| 17 | [Workspace Types](./17-workspace-types.md) | `WorkspaceTypesController` | 2 | Loại không gian + trọng số |
| 18 | [Recommendations](./18-recommendations.md) | `RecommendationsController` | 4 | Gợi ý phong thủy — 2 luồng (không gian / mang theo người) |
| 19 | [Reviews](./19-reviews.md) | `ReviewController` | 5 | Đánh giá sản phẩm |
| 20 | [Chat](./20-chat.md) | `ChatController` | 21 | Chat người↔người & người↔AI + SignalR `aiStatus` |
