...
public interface IUserService
{
    ...
    /// chỉ trả field tối thiểu (xem <see cref="UserSearchResponse"/>).
    /// </summary>
    Task<IServiceResult<List<UserSearchResponse>>> SearchAsync(string? q, int? limit, CancellationToken ct = default);
}
