...
namespace FengDeskAI.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260814122511_ProductPlacementAndPersonalRecommendation")]
    partial class ProductPlacementAndPersonalRecommendation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FengDeskAI.Domain.Entities.Catalog.Model3DRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("InternalFailureReason")
                        .HasColumnType("text")
                        .HasColumnName("internal_failure_reason");
                    ...
                    b.Property<List<Guid>>("SourceImageIds")
                        .IsRequired()
                        .HasColumnType("uuid[]")
                        .HasColumnName("source_image_ids");
                    ...
                    b.ToTable("model3d_requests", (string)null);
                });
            ...
            modelBuilder.Entity("FengDeskAI.Domain.Entities.Catalog.Product", b =>
                {
                    ...
                    b.Property<decimal?>("ElementHoa")
                        .HasColumnType("numeric(4,3)")
                        .HasColumnName("element_hoa");

                    b.Property<decimal?>("ElementKim")
                        .HasColumnType("numeric(4,3)")
                        .HasColumnName("element_kim");

                    b.Property<decimal?>("ElementMoc")
                        .HasColumnType("numeric(4,3)")
                        .HasColumnName("element_moc");

                    b.Property<decimal?>("ElementTho")
                        .HasColumnType("numeric(4,3)")
                        .HasColumnName("element_tho");

                    b.Property<decimal?>("ElementThuy")
                        .HasColumnType("numeric(4,3)")
                        .HasColumnName("element_thuy");
                    ...
                    b.Property<bool>("IsVectorOverridden")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("is_vector_overridden");
            ...
            modelBuilder.Entity("FengDeskAI.Domain.Entities.Identity.AuthorizationAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("FengDeskAI.Domain.Entities.Recommendation.ProductElementInput", b =>
                {
                    ...
                    b.ToTable("product_element_inputs", (string)null);
                });

            modelBuilder.Entity("FengDeskAI.Domain.Entities.Recommendation.ScoringParam", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("scoring_params", (string)null);
                });

            modelBuilder.Entity("FengDeskAI.Domain.Entities.Recommendation.WorkPurposeElementModifier", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("WorkPurpose", "Element")
                        .IsUnique()
                        .HasFilter("is_deleted = false");

                    b.ToTable("work_purpose_element_modifiers", (string)null);
                });

            modelBuilder.Entity("FengDeskAI.Domain.Entities.Recommendation.WorkspaceProfileInput", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("workspace_profile_inputs", (string)null);
                });

            modelBuilder.Entity("FengDeskAI.Domain.Entities.Recommendation.WorkspaceTypeElement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("WorkspaceTypeId", "Source", "Element")
                        .IsUnique()
                        .HasFilter("is_deleted = false");

                    b.ToTable("workspace_type_elements", (string)null);
                });
            ...
            modelBuilder.Entity("FengDeskAI.Domain.Entities.Workspace.WorkspaceProfile", b =>
                {
                    ...
                    b.Property<string>("DarkDirections")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                    ...
                    b.Property<string>("EntranceDirection")
                        .HasMaxLength(15)
                        .HasColumnType("character varying(15)")
                        .HasColumnName("entrance_direction");
                    ...
                    b.Property<string>("ToiletDirection")
                        .HasMaxLength(15)
                        .HasColumnType("character varying(15)")
                        .HasColumnName("toilet_direction");
            ...
            modelBuilder.Entity("FengDeskAI.Domain.Entities.Catalog.Model3DRequest", b =>
                {
                    b.HasOne("FengDeskAI.Domain.Entities.Catalog.Product", "Product")
                        .WithMany("Model3DRequests")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FengDeskAI.Domain.Entities.Catalog.ProductImage", "ProductImage")
                        .WithMany()
            ...
            modelBuilder.Entity("FengDeskAI.Domain.Entities.Catalog.ProductModel3D", b =>
                {
                    ...
                    b.HasOne("FengDeskAI.Domain.Entities.Catalog.ProductImage", "ProductImage")
                        .WithOne("Model3D")
                        .HasForeignKey("FengDeskAI.Domain.Entities.Catalog.ProductModel3D", "ProductImageId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("FengDeskAI.Domain.Entities.Recommendation.WorkspaceProfileInput", b =>
                {
                    b.HasOne("FengDeskAI.Domain.Entities.Workspace.WorkspaceProfile", null)
                        .WithMany()
                        .HasForeignKey("WorkspaceProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FengDeskAI.Domain.Entities.Sales.Delivery", b =>
                {
                    b.HasOne("FengDeskAI.Domain.Entities.Identity.User", "AssignedStaff")
                        .WithMany()
