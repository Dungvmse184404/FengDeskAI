...
public class WorkspaceTypeSeeder : IDataSeeder
{
    ...
    // (Name, IsPublic, PersonalWeight)
    private static readonly (string Name, bool IsPublic, decimal Weight, string Desc)[] SystemTypes =
    {
        ("Personal Desk", false, 1.0m, "Bàn làm việc cá nhân."),
        ("Home Office", false, 1.0m, "Phòng làm việc tại nhà, một người dùng."),
        ("Private Office", false, 1.0m, "Phòng làm việc riêng trong công ty."),
        ("Meeting Room", true, 0.5m, "Phòng họp dùng chung nhiều người."),
        ("Co-working Booth", true, 0.5m, "Khoang làm việc chia sẻ."),
        ("Open Workspace", true, 0.5m, "Khu làm việc mở dùng chung."),
        ("Reception / Lounge", true, 0.5m, "Khu lễ tân / tiếp khách chung."),
    };
